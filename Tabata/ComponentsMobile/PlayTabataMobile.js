...
const PlayTabataMobile = (props) => {
    ...
    console.log(currentTime, maxTime, selectedPlayMusic)
    useEffect(() => {
    ...
    useEffect(() => {
        ...
        tabataMobile.style.position = "static"
        const rowMobile = document.querySelector(".tabata__page__mobile__row")
        rowMobile.style.position = "static"
        rowMobile.style.padding = "0"
    }, [])
    const exitPlay = () => {
        setSecondsLeft(null)
        setStartSeconds("")
    ...
    const nextTasks = timerData.map((el, index) => {
        if (index > indexTimer && index <= indexTimer + (selectedPlayMusic !== "" ? 2 : 5)) {
            return (
                <div
                    className="tabata__page__mobile__play__music__next__tasks__item"
                    style={{
                        background:
                            el.info == "work"
                                ? " rgba(196, 52, 57, 1)"
    ...
    return (
        <div className="tabata__page__mobile__play">
            {indexTimer + 1 == timerData.length && secondsLeft == 0 ? (
                <div className="tabata__page__mobile__play__finish">
                ...
                <>
                    ...
                    {page == 1 ? (
                        <>
                            <div className="tabata__page__mobile__play__timer">
                                <div className="tabata__page__mobile__play__timer__box">
                                    {" "}
                                    <div
                                        className="tabata__page__mobile__play__timer__circle"
                                        style={{
                                    ...
                                    >
                                        <div className="tabata__page__mobile__play__timer__circle__hide">
                                            <h2
                                                style={{
                                                    color:
                                                        title == "work" ||
                                    ...
                                    <div className="tabata__page__mobile__play__timer__total">
                                        <h3>{formatTime(totalTime)}</h3>
                                    </div>
                                    <div className="tabata__page__mobile__play__timer__title">
                                        <h1
                                            style={{
                                                color:
                                                    title == "work" ||
                                    ...
                                    <div className="tabata__page__mobile__play__timer__buttons">
                                        {indexTimer + 1 == timerData.length && secondsLeft == 0 ? (
                                            ""
                                        ) : (
                                            <button
                                ...
                                <div className="tabata__page__mobile__play__switch">
                                    <button
                                        onClick={() => {
                                            setPage(1)
                                        }}
                                        ...
                                        className={
                                            page == 1
                                                ? "tabata__page__mobile__play__switch__circle tabata__page__mobile__play__switch__circle__selected"
                                                : "tabata__page__mobile__play__switch__circle"
                                        }
                                    ></button>
                                    <button
                                        className={
                        ...
                        <>
                            ...
                            {indexTimer + 1 !== timerData.length && secondsLeft == 0 ? (
                                ...
                                <ExportedImage
                                    src={getImage(
                                        getInfo(selectedPlayMusic.songs[indexMusic]).imageLink
                                    )}
                                    unoptimized={true}
                                    alt="chevronLeft"
                                    id="tabata__page__mobile__play__music__background"
                                    onClick={() => {
                                        enterFullScreen()
                                        setFullScreen(true)
                                    }}
                            ...
                            <div className="tabata__page__mobile__play__music">
                                {selectedPlayMusic !== "" ? (
                                    <>
                                        <div className="tabata__page__mobile__play__music__box">
                                            <h2>Musik</h2>
                                            <div className="tabata__page__mobile__play__music__box__music">
                                                <ExportedImage
                                                    src={getImage(
                                                        getInfo(
                                                            selectedPlayMusic.songs[indexMusic]
                                                        ).imageLink
                                                    )}
                                                    unoptimized={true}
                                                    alt="chevronLeft"
                                                ...
                                                />
                                                <div className="tabata__page__mobile__play__music__box__music__title">
                                                    <h3>
                                                        {
                                                            getInfo(
                                                                selectedPlayMusic.songs[indexMusic]
                                                ...
                                                {musicLoading ? (
                                                    <div className="tabata__page__mobile__play__music__box__music__loading">
                                                        <div className="loader"></div>
                                                    </div>
                                                ) : (
                                                    <>
                                                        <div className="tabata__page__mobile__play__music__box__music__currentTime">
                                                            {/* <div
                                            ...
                                            ></div> */}
                                                        ...
                                                        <div className="tabata__page__mobile__play__music__box__music__controls">
                                                            <>
                                                                <ExportedImage
                                                                    src={leftMusicImage}
                                                                    unoptimized={true}
                                ...
                                <div className="tabata__page__mobile__play__music__next">
                                    {indexTimer + 1 == timerData.length ? (
                                        <h2>Keine Aufgaben</h2>
                                    ) : (
                                        <h2>Kommende Aufgaben</h2>
                                    )}
                                    <div className="tabata__page__mobile__play__music__next__tasks">
                                        {nextTasks}
                                    </div>
                                </div>
                                <div className="tabata__page__mobile__play__switch">
...
export default PlayTabataMobile
