...
const EditTabataTimerMobile = (props) => {
    const {
        editTimer,
        setEditTimer,
        setAllTabatas,
    ...
    const timerDataMapping = timerData.map((el) => {
        ...
        return (
            <div className="tabata__page__mobile__editTabata__timer__item">
                <h3>{info}</h3>
                <div>
                    <h3>{value}</h3>
                    <p>{unit}</p>
    ...
    return (
        <>
            <div className="tabata__page__mobile__editTabata">
                {!showPlay ? (
                    <>
                        <div className="tabata__page__mobile__editTabata__title">
                            <ExportedImage
                                src={chevronLeft}
                                unoptimized={true}
                                alt="chevronLeft"
                                className="tabata__page__mobile__editTabata__title__return"
                                onClick={() => {
                                    setEditTimer("")
                            ...
                            />
                            <div className="tabata__page__mobile__editTabata__title__edit">
                                {showEditTitle ? (
                                    <span className="tabata__page__mobile__editTabata__title__edit__input">
                                        <input
                                            value={title}
                                            onChange={(e) => {
                                ...
                                <ExportedImage
                                    ...
                                    unoptimized={true}
                                    alt="editPen"
                                    className="tabata__page__mobile__editTabata__title__pen"
                                    onClick={() => {
                                        setShowEditTitle((el) => {
                                            return !el
                                        })
                        ...
                        <div className="tabata__page__mobile__editTabata__timer__box">
                            <div
                                className="tabata__page__mobile__editTabata__timer"
                                onScroll={(e) => {
                                    const timerContainer = document.querySelector(
                                        ".tabata__page__mobile__editTabata__timer"
                                    )
                                    const layer = document.querySelector(
                                        ".tabata__page__mobile__editTabata__timer__boxLayer"
                                    )
                                    if (
                            ...
                            <div className="tabata__page__mobile__editTabata__timer__boxLayer"></div>
                        </div>
                        <div className="tabata__page__mobile__editTabata__save">
                            {editTimer.title != title || !editTimer.uploaded ? (
                                <div className="tabata__page__mobile__editTabata__save__buttons">
                                    <button
                                        onClick={() => {
                                        ...
                                        id="tabata__page__mobile__editTabata__save__buttons__save"
                                    >
                                        {editTimer.uploaded
                                            ? "Speicher Änderungen"
                                            : "Speicher Tabata"}
                    ...
                    <>
                        ...
                        <div
                            className="tabata__page__mobile__editTabata__col2__workLayer"
                            style={{
                        ...
                        >
                            <div className="tabata__page__mobile__editTabata__col2__workLayer__hide">
                                <div
                                    className="tabata__page__mobile__editTabata__col2__restLayer"
                                    style={{
                                        background: `conic-gradient(rgba(196, 52, 57, 0.6) ${
                                            (restTime /
                                                (totalTime.minutes * 60 + totalTime.seconds)) *
                                                100 *
                                                3.6 +
                                            "deg"
                                        },rgba(196, 52, 57, 0.2)  0deg)`,
                                ...
                                >
                                    <div className="tabata__page__mobile__editTabata__col2__info">
                                        <div className="tabata__page__mobile__editTabata__col2__info__points">
                                            <div className="tabata__page__mobile__editTabata__col2__info__minutes">
                                                <h2>{totalTime.minutes}</h2>
                                                <p>min</p>
                                            </div>
                                            <h2>:</h2>
                                            <div className="tabata__page__mobile__editTabata__col2__info__seconds">
                        ...
                        <div className="tabata__page__mobile__editTabata__col2__legend">
                            <div className="tabata__page__mobile__editTabata__col2__legend__work">
                                <div className="tabata__page__mobile__editTabata__col2__legend__work__square"></div>
                                <p>Training</p>
                            </div>
                            <div className="tabata__page__mobile__editTabata__col2__legend__rest">
                                <div className="tabata__page__mobile__editTabata__col2__legend__rest__square"></div>
                                <p>Pause</p>
                            </div>
                        </div>
                        <div className="tabata__page__mobile__editTabata__col2__playlist">
                            <button
                                onClick={() => {
                                    setShowTabataEdit(false)
                                    setShowMusic(true)
                        ...
                        <div className="tabata__page__mobile__editTabata__col2__play">
                            <button
                                onClick={() => {
                                    enterFullScreen()
                                    window.scrollTo({
...
export default EditTabataTimerMobile
