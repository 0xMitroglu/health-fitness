...
const WeightTrackerPC = (props) => {
        ...
        .map((el, index) => {
            if (!isNaN(el)) {
                ...
                return (
                    <>
                        <div
                            className="weight__page__PC__history__box__item"
                            onClick={() => {
                                if (!editWeight) {
                                    setSelectedDate({
                        ...
                        >
                            <div className="weight__page__PC__history__box__item__col1">
                            ...
                            <div className="weight__page__PC__history__box__item__col2">
                                <div>
                                    <h3>{el}</h3>
                                    <p>kg</p>
                                </div>
                                {editWeight ? (
                                    <FontAwesomeIcon
                                        ...
                                        alt="icon"
                                        icon={faTrash}
                                        className="weight__page__PC__history__box__item__col2__fa"
                                    ></FontAwesomeIcon>
                                ) : (
                                    ""
                                )}
    ...
    const historyYear = yearWeightData
        ...
        .map((el, index) => {
            if (!isNaN(el)) {
                ...
                return (
                    <>
                        <div className="weight__page__PC__history__box__item">
                            <div className="weight__page__PC__history__box__item__col1">
                                <p>
        ...
        for (let i = 0; i < weight.length; i++) {
            if (weight[i].year == year && weight[i].month == month && weight[i].day == day) {
                ...
                const slider = document.querySelector(
                    ".weight__page__PC__newWeight__setWeight__select"
                )
    ...
    const selectWeight = weightNumbers.map((el, index) => {
        ...
        return (
            <div className="weight__page__PC__newWeight__setWeight__select__number">
    ...
    return (
        <>
            <div className="weight__page__PC page">
                <div className="weight__page__PC__row">
                    <div
                        className="weight__page__PC__col1"
                        style={{ display: weight.length == 0 ? "none" : "flex" }}
                    >
                        <h1 id="weight__page__PC__col1__title">Gewicht Tracker</h1>
                        <div className="weight__page__PC__selectTime">
                            <p
                                className={
                                    selectedTime == "week"
                                        ? "weight__page__PC__selectTime__selected"
                                        : ""
                                }
                                onClick={() => {
                        ...
                        <div className="weight__page__PC__nextprev">
                            <FontAwesomeIcon
                                alt="icon"
                                icon={faChevronLeft}
                                className="weight__page__PC__nextprev__left"
                                onClick={() => {
                            ...
                            {selectedTime == "week" ? (
                                <>
                                    {
                                        <p>
                                            {getDayNameGerman(week[0].index).substring(0, 3)},{" "}
                                            {week[0].day}.{" "}
                                            {getMonthNameGerman(week[0].month).substring(0, 3)}{" "}
                                            {" - "}
                                            {getDayNameGerman(week[6].index).substring(0, 3)},{" "}
                                            {week[6].day}.{" "}
                                            {getMonthNameGerman(week[6].month).substring(0, 3)}
                                        </p>
                                    }
                                </>
                            ) : (
                            ...
                            {!today ? (
                                <FontAwesomeIcon
                                    alt="icon"
                                    icon={faChevronRight}
                                    className="weight__page__PC__nextprev__right"
                                    onClick={() => {
                                        if (selectedTime == "week") {
                                        ...
                                        if (selectedTime == "month") {
                                            setMonth((el) => {
                                                return {
                                                    month: el.month + 1 > 12 ? 1 : el.month + 1,
                                                    year:
                                                        el.month + 1 > 12 ? el.year + 1 : el.year,
                                                }
                                            })
                                        }
                                        if (selectedTime == "year") {
                        ...
                        {selectedTime == "week" ? (
                            <div className="weight__page__PC__chartWeek">
                        ...
                        {selectedTime == "week" ? (
                            <div className="weight__page__PC__chartInfo">
                                ...
                                weekWeightInfo.beginningValue !== "" ? (
                                    ...
                                    <>
                                        <h2>Keine Daten</h2>
                                        <h6 style={{ fontWeight: "300" }}>Gewicht eingeben</h6>
                                    </>
                                )}
                            </div>
                        ) : (
                    ...
                    <div
                        className="weight__page__PC__col2"
                        style={{ display: weight.length == 0 ? "none" : "flex" }}
                    >
                        {!viewHistory ? (
                            <>
                                <div className="weight__page__PC__BMI">
                                    <h2>BMI</h2>
                                    <div className="weight__page__PC__box">
                                        {height !== "" && bmi !== "" ? (
                                            <div className="weight__page__PC__results">
                                                <div className="weight__page__PC__box__text">
                                                    <h2>{bmi}</h2>
                                                    <p>
                                                        {bmi <= 0
                                                ...
                                                <div className="weight__page__PC__box__info">
                                                    <div className="weight__page__PC__box__info__box underweight">
                                                        <p>Untergewicht</p>
                                                        {bmi < 18.5 ? (
                                                            <div
                                                                className="weight__page__PC__box__info__box__value"
                                                                style={{
                                                                    left:
                                                                        (81 / 8.5) * (bmi - 10) >=
                                                                        78
                                                    ...
                                                    <div className="weight__page__PC__box__info__box normal">
                                                        {" "}
                                                        <p>Normal</p>
                                                        {bmi >= 18.5 && bmi <= 24.9 ? (
                                                            <div
                                                    ...
                                                    <div className="weight__page__PC__box__info__box overweight">
                                                        <p>Übergewicht</p>
                                                        {bmi >= 25 && bmi < 30 ? (
                                                            <div
                                                                className="weight__page__PC__box__info__box__value"
                                                    ...
                                                    <div className="weight__page__PC__box__info__box obese">
                                                        <p>Adipositas</p>
                                                        {bmi >= 30 ? (
                                                            <div
                                                                className="weight__page__PC__box__info__box__value"
                                            ...
                                            <>
                                                <div className="weight__page__PC__box__input">
                                                    <input
                                        ...
                                        {height !== "" ? (
                                            <p
                                                id="weight__page__PC__box__change"
                                                onClick={() => {
                                                    setHeight("")
                                                }}
                                            >
                        ...
                        (yearWeightData.filter((item) => !isNaN(item)).length > 0 &&
                            ...
                            <>
                                <div
                                    className="weight__page__PC__history"
                                    style={{ marginTop: viewHistory ? "0px" : "20px" }}
                                >
                                    <div
                                        className="weight__page__PC__history__title"
                                        style={{
                                    ...
                                    >
                                        {viewHistory ? (
                                            <>
                                                ...
                                                <div className="weight__page__PC__history__title__fas">
                                                    <FontAwesomeIcon
                                                        alt="icon"
                                                        icon={faPen}
                                                        id="weight__page__PC__history__title__pen"
                                                        onClick={() => {
                                                            setEditWeight((el) => {
                                                                return !el
                                                            })
                                                    ...
                                                    <FontAwesomeIcon
                                                        alt="icon"
                                                        icon={faXmark}
                                                        id="weight__page__PC__history__title__return"
                                                        onClick={() => {
                                                            setViewHistory(false)
                                                        }}
                                                    ></FontAwesomeIcon>
                                        ...
                                        <p
                                            id="weight__page__PC__history__viewAll"
                                            onClick={() => {
                                                setViewHistory(true)
                                            }}
                                            style={{
                                    ...
                                    <div
                                        className="weight__page__PC__history__box"
                                        id={
                                            viewHistory
                                                ? "weight__page__PC__history__box__history"
                                                : "weight__page__PC__history__box__notHistory"
                                        }
                                    >
                                        {selectedTime == "week"
                                            ? historyWeek
                    ...
                    <div
                        className="weight__page__PC__col3"
                        style={{
                            margin: weight.length == 0 ? "0px auto" : "0px",
                            paddingTop: weight.length == 0 ? "10px" : "0px",
                        }}
                    >
                        {" "}
                        <div className="weight__page__PC__newWeight">
                            <div className="weight__page__PC__newWeight__title">
                                <h1
                                    style={{
                                        fontSize: weight.length == 0 ? "35px" : "23px",
                                    }}
                                >
                                    Neues Gewicht
                                </h1>
                            </div>
                            <div className="weight__page__PC__newWeight__calender">
                                <div className="weight__page__PC__newWeight__calender__nav">
                                    <FontAwesomeIcon
                                        alt="icon"
                                        icon={faChevronLeft}
                                        className="weight__page__PC__newWeight__calender__nav__fa"
                                        onClick={() => {
                                            setMonthCalender((el) => {
                                                return {
                                                    month: el.month - 1 < 1 ? 12 : el.month - 1,
                                    ...
                                    monthCalender.year == currentDate.year ? (
                                        <div className="weight__page__PC__newWeight__calender__nav__fa"></div>
                                    ) : (
                                        <FontAwesomeIcon
                                            alt="icon"
                                            icon={faChevronRight}
                                ...
                                <div className="weight__page__PC__newWeight__calender__dayTitle">
                                    <p>M</p>
                                    <p>D</p>
                                    <p>M</p>
                                    <p>D</p>
                                ...
                                <div className="weight__page__PC__newWeight__calender__calender">
                                    {calender}
                                </div>
                            </div>
                            <div className="weight__page__PC__newWeight__setWeight">
                                <div className="weight__page__PC__newWeight__setWeight__number"></div>
                                <div
                                    className="weight__page__PC__newWeight__setWeight__select"
                                    onMouseDown={(e) => {
                                        const slider = document.querySelector(
                                            ".weight__page__PC__newWeight__setWeight__select"
                                        )
                                ...
                                <div class="box__select__value">
                                    <ExportedImage
                                        ...
                                        unoptimized={true}
                                        alt="fullLine"
                                        class="weight__page__PC__newWeight__setWeight__select__number__commaLine"
                                    />
                                </div>
                                <div className="weight__page__PC__newWeight__setWeight__number">
                                    <div>
                                        ...
                                        ></input>
                                        <span className="weight__page__PC__newWeight__setWeight__number__prefix">
                                            {newWeight !== "" ? "kg" : ""}
                                        </span>
                                    </div>
                                </div>
                            ...
                            {weightSelected ? (
                                <div className="weight__page__PC__newWeight__save">
                                    <button
                                        onClick={() => {
                                            if (newWeight !== "") {
                                                let array = weight
...
export default WeightTrackerPC
