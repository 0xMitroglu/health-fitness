...
const WeightTrackerMobile = (props) => {
    const {
        selectedTime,
        setSelectedTime,
        today,
        ...
        .map((el, index) => {
            if (!isNaN(el)) {
                ...
                return (
                    <>
                        <div
                            className="weight__page__mobile__history__box__item"
                            onClick={() => {
                                if (!editWeight) {
                        ...
                        >
                            <div className="weight__page__mobile__history__box__item__col1">
                            ...
                            <div className="weight__page__mobile__history__box__item__col2">
                                <div>
                                    <h3>{el}</h3>
                                    <p>kg</p>
                                </div>
                                {editWeight ? (
                                    <FontAwesomeIcon
                                        ...
                                        alt="icon"
                                        icon={faTrash}
                                        className="weight__page__mobile__history__box__item__col2__fa"
                                    ></FontAwesomeIcon>
                                ) : (
                                    ""
                                )}
    ...
    const historyYear = yearWeightData
        ...
        .map((el, index) => {
            if (!isNaN(el)) {
                ...
                return (
                    <>
                        <div className="weight__page__mobile__history__box__item">
                            <div className="weight__page__mobile__history__box__item__col1">
                                <p>
        ...
        for (let i = 0; i < weight.length; i++) {
            if (weight[i].year == year && weight[i].month == month && weight[i].day == day) {
                ...
                const slider = document.querySelector(
                    ".weight__page__mobile__newWeight__setWeight__select"
                )
    ...
    const selectWeight = weightNumbers.map((el, index) => {
        ...
        return (
            <div className="weight__page__mobile__newWeight__setWeight__select__number">
    ...
    return (
        <>
            {" "}
            <div className="weight__page__mobile page">
                <div className="weight__page__mobile__row">
                    {selectedDate == "" ? (
                        <>
                            {!viewHistory ? (
                                <>
                                    ...
                                    <div className="weight__page__mobile__selectTime">
                                        <p
                                            className={
                                                selectedTime == "week"
                                                    ? "weight__page__mobile__selectTime__selected"
                                                    : ""
                                            }
                                            onClick={() => {
                                    ...
                                    <div className="weight__page__mobile__nextprev">
                                        <FontAwesomeIcon
                                            alt="icon"
                                            icon={faChevronLeft}
                                            className="weight__page__mobile__nextprev__left"
                                            onClick={() => {
                                        ...
                                        {!today ? (
                                            <FontAwesomeIcon
                                                alt="icon"
                                                icon={faChevronRight}
                                                className="weight__page__mobile__nextprev__right"
                                                onClick={() => {
                                                    if (selectedTime == "week") {
                                    ...
                                    {selectedTime == "week" ? (
                                        <div className="weight__page__mobile__chartWeek">
                                    ...
                                    {selectedTime == "week" ? (
                                        <div className="weight__page__mobile__chartInfo">
                                            ...
                                            weekWeightInfo.beginningValue !== "" ? (
                                                <>
                                                    ...
                                                    <p>
                                                        ...
                                                        {weekWeightInfo.difference} kg in dieser
                                                        Woche
                                                    </p>
                                                </>
                                            ) : (
                                                ...
                                                <>
                                                    ...
                                                    <p>
                                                        {monthWeightInfo.difference >= 0
                                                            ? "+"
                                                            : ""}
                                                        {monthWeightInfo.difference} kg in diesem
                                                        Monat
                                                    </p>
                                                </>
                                            ) : (
                                            ...
                                            yearWeightInfo.beginningValue !== "" ? (
                                                <>
                                                    ...
                                                    <p>
                                                        ...
                                                        {yearWeightInfo.difference} kg in diesem
                                                        Jahr
                                                    </p>
                                                </>
                                            ) : (
                                    ...
                                    <div className="weight__page__mobile__BMI">
                                        <h2>BMI</h2>
                                        <div className="weight__page__mobile__box">
                                            {height !== "" && bmi !== "" ? (
                                                <div className="weight__page__mobile__results">
                                                    <div className="weight__page__mobile__box__text">
                                                        <h2>{bmi}</h2>
                                                        <p>
                                                            {bmi <= 0
                                                    ...
                                                    <div className="weight__page__mobile__box__info">
                                                        <div className="weight__page__mobile__box__info__box underweight">
                                                            <p>Untergewicht</p>
                                                            {bmi < 18.5 ? (
                                                                <div
                                                                    className="weight__page__mobile__box__info__box__value"
                                                                    style={{
                                                                        left:
                                                                            (81 / 8.5) *
                                                                                (bmi - 10) >=
                                                        ...
                                                        <div className="weight__page__mobile__box__info__box normal">
                                                            {" "}
                                                            <p>Normal</p>
                                                            {bmi >= 18.5 && bmi <= 24.9 ? (
                                                                <div
                                                        ...
                                                        <div className="weight__page__mobile__box__info__box overweight">
                                                            <p>Übergewicht</p>
                                                            {bmi >= 25 && bmi < 30 ? (
                                                                <div
                                                                    className="weight__page__mobile__box__info__box__value"
                                                        ...
                                                        <div className="weight__page__mobile__box__info__box obese">
                                                            <p>Adipositas</p>
                                                            {bmi >= 30 ? (
                                                                <div
                                                                    className="weight__page__mobile__box__info__box__value"
                                                ...
                                                <>
                                                    <div className="weight__page__mobile__box__input">
                                                        <input
                                            ...
                                            {height !== "" ? (
                                                <p
                                                    id="weight__page__mobile__box__change"
                                                    onClick={() => {
                                                        setHeight("")
                                                    }}
                                                >
                            ...
                            (yearWeightData.filter((item) => !isNaN(item)).length > 0 &&
                                ...
                                <>
                                    <div
                                        className="weight__page__mobile__history"
                                        style={{ marginTop: viewHistory ? "0px" : "20px" }}
                                    >
                                        <div
                                            className="weight__page__mobile__history__title"
                                            style={{
                                        ...
                                        >
                                            {viewHistory ? (
                                                <>
                                                    ...
                                                    <div className="weight__page__mobile__history__title__fas">
                                                        <FontAwesomeIcon
                                                            alt="icon"
                                                            icon={faPen}
                                                            id="weight__page__mobile__history__title__pen"
                                                            onClick={() => {
                                                                setEditWeight((el) => {
                                                                    return !el
                                                                })
                                                        ...
                                                        <FontAwesomeIcon
                                                            alt="icon"
                                                            icon={faXmark}
                                                            id="weight__page__mobile__history__title__return"
                                                            onClick={() => {
                                                                setViewHistory(false)
                                                                window.scrollTo({
                                                                    top: 0,
                                            ...
                                            <p
                                                id="weight__page__mobile__history__viewAll"
                                                onClick={() => {
                                                    setViewHistory(true)
                                                    window.scrollTo({
                                                        top: 0,
                                        ...
                                        <div
                                            className="weight__page__mobile__history__box"
                                            id={
                                                viewHistory
                                                    ? "weight__page__mobile__history__box__history"
                                                    : "weight__page__mobile__history__box__notHistory"
                                            }
                                        >
                                            {selectedTime == "week"
                                                ? historyWeek
                            ...
                            <div className="weight__page__mobile__addWeightButton">
                                <button
                                    onClick={() => {
                                        setViewHistory(false)
                        ...
                        <div className="weight__page__mobile__newWeight">
                            <div
                            ...
                            <div className="weight__page__mobile__newWeight__calender">
                                <div className="weight__page__mobile__newWeight__calender__nav">
                                    <FontAwesomeIcon
                                        alt="icon"
                                        icon={faChevronLeft}
                                        className="weight__page__mobile__newWeight__calender__nav__fa"
                                        onClick={() => {
                                            setMonthCalender((el) => {
                                                return {
                                    ...
                                    monthCalender.year == currentDate.year ? (
                                        <div className="weight__page__mobile__newWeight__calender__nav__fa"></div>
                                    ) : (
                                        <FontAwesomeIcon
                                            alt="icon"
                                            icon={faChevronRight}
                                ...
                                <div className="weight__page__mobile__newWeight__calender__dayTitle">
                                    <p>M</p>
                                    <p>D</p>
                                    <p>M</p>
                                    <p>D</p>
                                ...
                                <div className="weight__page__mobile__newWeight__calender__calender">
                                    {calender}
                                </div>
                            </div>
                            <div className="weight__page__mobile__newWeight__setWeight">
                                <div className="weight__page__mobile__newWeight__setWeight__number"></div>
                                <div
                                    className="weight__page__mobile__newWeight__setWeight__select"
                                    onMouseDown={(e) => {
                                        const slider = document.querySelector(
                                            ".weight__page__mobile__newWeight__setWeight__select"
                                        )
                                ...
                                <div class="box__select__value">
                                    <ExportedImage
                                        ...
                                        unoptimized={true}
                                        alt="fullLine"
                                        class="weight__page__mobile__newWeight__setWeight__select__number__commaLine"
                                    />
                                </div>
                            ...
                            {weightSelected ? (
                                <div className="weight__page__mobile__newWeight__save">
                                    <button
                                        onClick={() => {
                                            if (newWeight !== "") {
                                                let array = weight
