...
const NutritionPlaner = (props) => {
    ...
    const foodsMapping = foods.map((el, index) => {
        ...
        return (
            <>
                <div className="nutritionPlaner__page__daily__food" key={index}>
                    <img src={el.image} alt="img"></img>
                    <div className="nutritionPlaner__page__daily__food__info">
                        <h1>
                    ...
                    {showEditFood !== index ? (
                        <>
                            <div className="nutritionPlaner__page__daily__food__details">
                                <div className="nutritionPlaner__page__daily__food__details__protein">
                                    <div className="nutritionPlaner__page__daily__food__details__bar">
                                        <div
                                            className="nutritionPlaner__page__daily__food__details__value"
                                            style={{ height: proteinHeight }}
                                        ></div>
                                    </div>
                                    <div className="nutritionPlaner__page__daily__food__details__text">
                                        <h2>{el.proteins}g</h2>
                                        <p>Protein</p>
                                    </div>
                                </div>
                                <div className="nutritionPlaner__page__daily__food__details__carb">
                                    <div className="nutritionPlaner__page__daily__food__details__bar">
                                        <div
                                            className="nutritionPlaner__page__daily__food__details__value"
                                ...
                                <div className="nutritionPlaner__page__daily__food__details__fat">
                                    <div className="nutritionPlaner__page__daily__food__details__bar">
                                        <div
                                            className="nutritionPlaner__page__daily__food__details__value"
                        ...
                        <div className="nutritionPlaner__page__daily__food__edit">
                            <button
                                onClick={() => {
                    ...
                    <div
                        className="nutritionPlaner__page__daily__food__points"
                        onClick={() => {
                    ...
                    >
                        <div className="nutritionPlaner__page__daily__food__point"></div>
                        <div className="nutritionPlaner__page__daily__food__point"></div>
                        <div className="nutritionPlaner__page__daily__food__point"></div>
                    </div>
                </div>
            ...
            <div
                className={
                    ...
                    el.day == selectedDate.day
                        ? "nutritionPlaner__page__daily__week__day nutritionPlaner__page__daily__week__this"
                        : "nutritionPlaner__page__daily__week__day"
                }
                key={index}
                onClick={() => {
    ...
    useEffect(() => {
        const layer = document.querySelector(
            ".nutritionPlaner__page__daily__results__button__layer"
        )
    ...
    return (
        <div className="nutritionPlaner__page page">
            <div className="nutritionPlaner__page__row">
                <div className="nutritionPlaner__page__daily">
                    <h1>Tägliche Mahlzeiten</h1>
                    <div className="nutritionPlaner__page__daily__week">
                        <FontAwesomeIcon
                            alt="icon"
                            icon={faChevronLeft}
                        ...
                        {!actualWeek ? (
                            <p
                                className="nutritionPlaner__page__daily__week__return"
                                onClick={() => {
                    ...
                    <div className="nutritionPlaner__page__daily__select">
                        <select
                            onChange={(e) => {
                    ...
                    <div className="nutritionPlaner__page__daily__foods">{foodsMapping}</div>
                </div>
                <div className="nutritionPlaner__page__daily__results">
                    <h1>Resultate</h1>
                    <div className="nutritionPlaner__page__daily__results__buttons">
                        <button
                            onClick={() => {
                        ...
                        <div className="nutritionPlaner__page__daily__results__button__layer"></div>
                        <div className="nutritionPlaner__page__daily__results__button__info">
                            {caloriesCalculator !== "" ? (
                                <ExportedImage
                                    src={info}
                                    unoptimized={true}
                            ...
                            {showInfo ? (
                                <div className="nutritionPlaner__page__daily__results__button__info__box">
                                    {caloriesCalculator !== "" ? (
                                        <>
                    ...
                    <div className="nutritionPlaner__page__daily__results__calories">
                            ...
                            <>
                                {caloriesCalculator == "" ? (
                                    <>
                                        <p>
                                            Du hast{" "}
                                            <span className="nutritionPlaner__page__daily__results__calories__underline">
                                                {total.daily.calories}{" "}
                                            </span>
                                            Kalorien gegessen
                                        </p>
                                        <div className="nutritionPlaner__page__daily__results__calories__bar">
                                            <div
                                                className="nutritionPlaner__page__daily__results__calories__value"
                                                style={{
                                                    width: `${
                                                        parseInt(total.daily.percentage.calories) +
                                                        "%"
                                                    } `,
                                                }}
                                            ></div>
                                            <p id="calories__eaten">{total.daily.calories} kcal</p>
                                            <p id="calories__indicator">3000 kcal</p>
                                        </div>
                                    </>
                                ) : (
                                    <>
                                        {caloriesCalculator.calories >= total.daily.calories ? (
                                            <p>
                                                Du kannst noch{" "}
                                                <span className="nutritionPlaner__page__daily__results__calories__underline">
                                    ...
                                    <>
                                        ...
                                        total.weekly.calories ? (
                                            ...
                                            <p>
                                                Du hast{" "}
                                                <span className="nutritionPlaner__page__daily__results__calories__underline">
                                                    {parseInt(total.weekly.calories) -
                                                        parseInt(caloriesCalculator.calories) *
                                                            7}{" "}
                                                </span>
                                                Kalorien mehr gegessen
                                            </p>
                                        ...
                                        <div className="nutritionPlaner__page__daily__results__calories__bar">
                                            ...
                                            ></div>
                                            <p id="calories__eaten">
                                                {parseInt(total.weekly.percentage.calories)} kcal
                                                gegessen
                                            </p>
                                            <p id="calories__indicator">
                                                Ziel:{" "}
                                                {parseInt(total.weekly.percentage.calories) * 7}{" "}
                                                kcal
                                            </p>
                                        </div>
                                    </>
                    ...
                    <div className="nutritionPlaner__page__daily__results__info">
                        {caloriesCalculator == "" ? (
                            <>
                                {resultsSelector == "daily" ? (
                                    <>
                                        <div
                                            className="nutritionPlaner__page__daily__results__info__proteins"
                                            style={{
                                                background: `conic-gradient(rgba(196, 52, 58, 1) ${
                                                    total.daily.percentage.proteins * 3.6 + "deg"
                                                }, rgba(196, 52, 58, 0.3) 0deg)`,
                                            }}
                                        >
                                            <div className="nutritionPlaner__page__daily__results__info__text">
                                                <h3>
                                                    {parseInt(total.daily.percentage.proteins)}%
                                                </h3>{" "}
                                                <p>Proteine</p>
                                            </div>
                                            <div className="nutritionPlaner__page__daily__results__info__amount">
                                                {parseInt(total.daily.proteins)}g
                                            </div>
                                        </div>
                                        <div
                                            className="nutritionPlaner__page__daily__results__info__carbs"
                                            style={{
                                                background: `conic-gradient(rgba(196, 52, 58, 1) ${
                                        ...
                                        >
                                            <div className="nutritionPlaner__page__daily__results__info__text">
                                                <h3> {parseInt(total.daily.percentage.carbs)}%</h3>
                                                <p>Kohlenhydrate</p>
                                            </div>
                                            <div className="nutritionPlaner__page__daily__results__info__amount">
                                                {parseInt(total.daily.carbs)}g
                                            </div>
                                        </div>
                                        <div
                                            className="nutritionPlaner__page__daily__results__info__fat"
                                            style={{
                                                background: `conic-gradient(rgba(196, 52, 58, 1) ${
                                        ...
                                        >
                                            <div className="nutritionPlaner__page__daily__results__info__text">
                                                <h3>{parseInt(total.daily.percentage.fat)}%</h3>
                                                <p>Fett</p>
                                            </div>
                                            <div className="nutritionPlaner__page__daily__results__info__amount">
                                                {parseInt(total.daily.fat)}g
                                            </div>
                                        </div>
                                    </>
                                ) : (
                                    <>
                                        <div
                                            ...
                                            style={{
                                                background: `conic-gradient(rgba(196, 52, 58, 1) ${
                                                    total.weekly.percentage.proteins * 3.6 + "deg"
                                                }, rgba(196, 52, 58, 0.3) 0deg)`,
                                            }}
                                        >
                                            <div className="nutritionPlaner__page__daily__results__info__text">
                                                <h3>
                                                    {parseInt(total.weekly.percentage.proteins)}%
                                                </h3>{" "}
                                                <p>Proteine</p>
                                            </div>
                                            <div className="nutritionPlaner__page__daily__results__info__amount">
                                        ...
                                        >
                                            <div className="nutritionPlaner__page__daily__results__info__text">
                                                <h3>{parseInt(total.weekly.percentage.fat)}%</h3>
                                                <p>Fett</p>
                                            </div>
                                            <div className="nutritionPlaner__page__daily__results__info__amount">
                                                {total.weekly.fat}g
                            ...
                            <>
                                {resultsSelector == "daily" ? (
                                    ...
                                    <>
                                        ...
                                        >
                                            <div className="nutritionPlaner__page__daily__results__info__text">
                                                <h3>{parseInt(total.weekly.percentage.carbs)}%</h3>
                                                <p>Kohlenhydrate</p>
                                            </div>
                                            <div className="nutritionPlaner__page__daily__results__info__amount">
